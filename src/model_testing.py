...
id_to_name = {}
with open("classify_dataset/labels.csv", newline='', encoding='utf8') as f:
...
for sign_class in range(CLASS_NUM):
    test_signs = listdir("./classify_dataset/test/{}".format(sign_class))
    for sign_file in test_signs:
        path = "./classify_dataset/test/{}/{}".format(sign_class, sign_file)
